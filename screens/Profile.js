...
const firstItem = () => {
  return (
    <View>
      <TouchableOpacity>
        <Avatar rounded containerStyle={{alignSelf: "center", paddingBottom: 10}} size="large" source={{uri: "https://c8.alamy.com/comp/2HYCH09/larry-david-attending-the-natural-resources-defense-councils-stand-up!-event-at-the-wallis-annenberg-center-for-the-performing-arts-2HYCH09.jpg"}}/>
      </TouchableOpacity>
    </View>
  );
};
          ...
          <View style={styles.form}>
            <FlatList
              ...
              <KeyboardAwareScrollView>
                <Input labelStyle={{fontWeight: "normal",}} inputStyle={{color: "white", fontSize: 14}} label={item.field} />
              </KeyboardAwareScrollView>}
            />
          </View>
      </View>
